...
export class NoteEditor {
	...
	private inferNoteKind(
		...
		// This fallback is used only when older or malformed analysis output does
		// not provide noteKind. Explicit learning cues take precedence over size.
		if (
		...
		// A code-heavy document is more likely to be an operational snippet than
		// an explanatory reference, even when it contains some prose.
